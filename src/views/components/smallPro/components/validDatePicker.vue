...
<el-row>
    <el-col :span="10">
        <el-date-picker size="mini" :clearable="false" v-model="dateStart" type="date" placeholder="选择开始日期">
        </el-date-picker>
    </el-col>
    <el-col :span="10">
        <el-date-picker size="mini" :clearable="false" :disabled="selfIsLong" v-model="dateEnd" type="date" placeholder="选择结束日期">
        </el-date-picker>
    </el-col>
    <el-col :span="2">
